...
{
    unsafe class Fusion_Frameworks_UI_UIUtility_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Fusion.Frameworks.UI.UIUtility);
            MethodInfo[] methods = type.GetMethods(flag).Where(t => !t.IsGenericMethod).ToArray();
            args = new Type[]{typeof(UnityEngine.GameObject), typeof(System.String)};
            method = methods.Where(t => t.Name.Equals("Find") && t.CheckMethodParams(args)).Single();
            app.RegisterCLRMethodRedirection(method, Find_0);
            args = new Type[]{typeof(UnityEngine.GameObject), typeof(System.Action)};
            method = type.GetMethod("RegisterButtonAction", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, RegisterButtonAction_1);
            args = new Type[]{typeof(UnityEngine.GameObject), typeof(System.String)};
            method = type.GetMethod("SetText", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, SetText_2);
        ...
        static StackObject* Find_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = Fusion.Frameworks.UI.UIUtility.Find(@gameObject, @path);

            return ILIntepreter.PushObject(__ret, __mStack, result_of_this_method);
        }

        static StackObject* RegisterButtonAction_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
            ...
            Fusion.Frameworks.UI.UIUtility.RegisterButtonAction(@gameObject, @callback);

            return __ret;
        }

        static StackObject* SetText_2(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
            ...
            Fusion.Frameworks.UI.UIUtility.SetText(@gameObject, @str);
