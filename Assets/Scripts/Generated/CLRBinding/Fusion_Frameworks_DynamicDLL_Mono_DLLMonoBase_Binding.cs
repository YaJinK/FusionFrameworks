...
{
    unsafe class Fusion_Frameworks_DynamicDLL_Mono_DLLMonoBase_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Fusion.Frameworks.DynamicDLL.Mono.DLLMonoBase);
            args = new Type[]{};
        ...
        static StackObject* Awake_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Fusion.Frameworks.DynamicDLL.Mono.DLLMonoBase instance_of_this_method = (Fusion.Frameworks.DynamicDLL.Mono.DLLMonoBase)typeof(Fusion.Frameworks.DynamicDLL.Mono.DLLMonoBase).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
